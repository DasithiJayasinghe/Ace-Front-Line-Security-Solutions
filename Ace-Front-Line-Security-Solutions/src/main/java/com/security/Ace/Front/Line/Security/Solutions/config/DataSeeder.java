    ...
    CommandLineRunner initDatabase(
        ...
        return args -> {
            if (userRepository.count() == 0) {
                ...
                // Area Manager
                userRepository.save(new User(null, "areamanager@ace.com", "area123", "AREA_MANAGER", null, null, colombo));
                userRepository.save(new User(null, "areamanager1@ace.com", "area123", "AREA_MANAGER", null, null, kandy));
                userRepository.save(new User(null, "areamanager2@ace.com", "area123", "AREA_MANAGER", null, null, kurunegala));
                userRepository.save(new User(null, "areamanager3@ace.com", "area123", "AREA_MANAGER", null, null, rathnapura));
