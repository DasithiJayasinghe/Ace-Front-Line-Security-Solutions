...
public interface InvoiceRepository extends JpaRepository<Invoice, Integer> {
    ...
    // Pending invoices for a client — ISSUED or PAYMENT_UPLOADED or PAYMENT_REJECTED
    ...
    // Overdue invoices — ISSUED past due date, or PAYMENT_UPLOADED/REJECTED past grace period
    ...
    // Total outstanding = all ISSUED + PAYMENT_UPLOADED + PAYMENT_REJECTED + OVERDUE
