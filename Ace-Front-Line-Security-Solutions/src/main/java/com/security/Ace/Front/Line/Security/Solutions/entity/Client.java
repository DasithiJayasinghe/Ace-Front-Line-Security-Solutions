...
public class Client {
    ...
    // Single OT rate (kept for backward compat; prefer rank-specific fields below)
    @Column(name = "ot_rate_per_hour", precision = 10, scale = 2)
    private BigDecimal otRatePerHour;

    // OT rate per hour specifically for OIC officers
    @Column(name = "oic_ot_rate_per_hour", precision = 10, scale = 2)
    private BigDecimal oicOtRatePerHour;

    // OT rate per hour specifically for JSO officers
    @Column(name = "jso_ot_rate_per_hour", precision = 10, scale = 2)
