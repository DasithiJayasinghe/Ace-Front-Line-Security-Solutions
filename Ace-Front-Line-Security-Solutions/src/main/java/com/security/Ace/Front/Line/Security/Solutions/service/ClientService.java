...
import com.security.Ace.Front.Line.Security.Solutions.entity.RiskLevel;
...
public class ClientService {
    ...
    public ClientResponse registerClient(ClientRegistrationRequest request) {
        ...
        client.setOicOtRatePerHour(request.getOicOtRatePerHour());
        client.setJsoOtRatePerHour(request.getJsoOtRatePerHour());
        // Risk assessment
    ...
    public ClientResponse updateClient(Integer clientId, ClientUpdateRequest request) {
        ...
        if (request.getOicOtRatePerHour() != null)       client.setOicOtRatePerHour(request.getOicOtRatePerHour());
        if (request.getJsoOtRatePerHour() != null)       client.setJsoOtRatePerHour(request.getJsoOtRatePerHour());
    ...
    private ClientResponse mapToResponse(Client client) {
        ...
        response.setOicOtRatePerHour(client.getOicOtRatePerHour());
        response.setJsoOtRatePerHour(client.getJsoOtRatePerHour());
