    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .hasAnyRole("ADMIN", "OPERATIONAL_MANAGER")
                        .requestMatchers("/api/feedback/*/flag")
                        .hasAnyRole("ADMIN", "OPERATIONAL_MANAGER")
                        .requestMatchers("/api/feedback/*/reply")
                        .hasAnyRole("ADMIN", "OPERATIONAL_MANAGER")
                        .requestMatchers("/api/feedback/report")
                        .hasAnyRole("ADMIN", "OPERATIONAL_MANAGER")
                        ...
                        .hasAnyRole("CLIENT", "ACCOUNTANT", "ADMIN")
                        .requestMatchers("/api/payments/*/proof")
                        .hasAnyRole("CLIENT", "ACCOUNTANT", "ADMIN")
