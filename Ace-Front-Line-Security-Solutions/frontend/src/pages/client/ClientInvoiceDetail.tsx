    ...
    return (
        <div className="space-y-5">
                ...
                <nav className="flex items-center gap-1.5 text-xs text-gray-500">
                    ...
                    <ChevronRight className="h-3 w-3" />
                    <span className="text-gray-900 font-semibold">{invoice.invoiceNumber ?? `INV-${invoice.invoiceId}`}</span>
                </nav>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <button onClick={() => window.print()}
                            className="flex items-center gap-1.5 border border-gray-200 text-gray-700 hover:bg-gray-50 px-4 py-2 rounded-xl text-sm font-semibold transition-all">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden print:shadow-none">
                    ...
                    <div className="px-8 py-6 space-y-6">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
                            {[
                                ...
                                <div key={label}>
                                    ...
                                    <p className={`font-semibold mt-0.5 ${red ? "text-red-600" : "text-gray-900"}`}>{value}</p>
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div className="bg-primary/5 border-2 border-primary/20 rounded-xl p-4 flex flex-col justify-center">
                        ...
                        {invoice.items && invoice.items.length > 0 && (
                            <div>
                                <p className="text-[11px] font-bold uppercase tracking-widest text-gray-400 mb-3">Service Details</p>
                                    ...
                                    <table className="w-full text-sm text-left">
                                        ...
                                        {invoice.items.map((item: any, i: number) => (
                                            <tr key={i} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-3 text-right text-gray-600">{item.quantity ?? item.hours ?? "—"}</td>
                        ...
                        <div className="flex justify-end">
                            <div className="w-full sm:w-80 space-y-2 text-sm">
                                ...
                                <div className="border-t-2 border-gray-900 pt-2 mt-2 flex justify-between font-black text-base text-gray-900">
                                    <span>TOTAL DUE</span>
                        ...
                        <div className="border border-gray-100 rounded-xl p-5 space-y-4 bg-gray-50/50">
                            <p className="font-bold text-sm text-gray-900">Payment Instructions</p>
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
                                {[
                                    ...
                                    <div key={label}>
                                        ...
                                        <p className="font-semibold text-gray-900 mt-0.5 text-xs">{value}</p>
                                    </div>
                                ))}
                            </div>
                            <div className="bg-primary/10 border border-primary/30 rounded-lg p-3">
                                <p className="text-[11px] font-bold text-primary uppercase tracking-wide mb-1">⚠ Mandatory Reference</p>
                                <p className="font-black text-gray-900 text-base">{invoice.invoiceNumber ?? `INV-${invoice.invoiceId}`}</p>
                                <p className="text-xs text-gray-600 mt-0.5">Always include this reference in your bank transfer description.</p>
                            </div>
                        </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div>
                        <p className="font-bold text-sm text-gray-900">Have questions about this invoice?</p>
                        <p className="text-xs text-gray-500 mt-0.5">Contact our billing support team for assistance.</p>
                    </div>
                    <a href="tel:0114848177"
                        className="flex items-center gap-2 bg-gray-900 hover:bg-gray-800 text-white px-5 py-2.5 rounded-xl text-sm font-bold transition-all shrink-0">
