        ...
        <div className="p-6 bg-[#0D0D0D] min-h-screen text-white">
            ...
            {currentUser && (
                <div className="mb-4 text-sm text-gray-400">
                    ...
                    {currentUser.clientCompanyName || "Not assigned"}
                </div>
            )}

            <div className="flex items-center justify-between bg-[#1A1A1A] border border-gray-800 rounded p-4 mb-6">
                <button
                    onClick={handlePreviousMonth}
                    className="px-4 py-2 rounded bg-[#1A1A1A] border border-[#D4AF37] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-black transition"
                >
                    ← Previous
                </button>
            ...
            {loading && !selectedSchedule ? (
                ...
                <div className="space-y-4">
                    ...
                    {!isPastMonth ? (
                        <button
                            ...
                            disabled={loading || !currentUser?.clientCompanyId}
                            className="bg-[#D4AF37] text-black px-6 py-2 rounded font-bold hover:bg-yellow-600 disabled:opacity-50"
                        >
                ...
                <div className="space-y-6">
                    <div className="bg-[#1A1A1A] p-4 rounded border border-[#D4AF37] space-y-3">
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex gap-4">
                                <button
                                    ...
                                    className="bg-[#1A1A1A] text-[#D4AF37] border border-[#D4AF37] px-4 py-2 rounded hover:bg-[#D4AF37] hover:text-black font-semibold transition disabled:opacity-50"
                                >
                                ...
                                <button
                                    ...
                                    disabled={loading || !canEditDraft}
                                    className="bg-[#D4AF37] text-black px-4 py-2 rounded hover:bg-yellow-600 font-bold disabled:opacity-50"
                                >
                                    Submit Schedule
                                </button>
                            </div>
