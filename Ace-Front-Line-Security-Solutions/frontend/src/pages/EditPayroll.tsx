...
const EditPayroll = () => {
    ...
    useEffect(() => {
        const fetchRecord = async () => {
            try {
                ...
                toast.error("Connection error while loading record.");
            } finally {
                setIsLoading(false);
            }
        };
    ...
    const overtimeAmount = overtimeAllowance?.amount ?? (record.totalShifts * record.otRate);
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="pt-4 space-y-2">
                                    <div className="flex gap-2">
                                        ...
                                        <Input type="number" placeholder="Amount" value={newAllowance.amount} onChange={(e) => setNewAllowance({ ...newAllowance, amount: e.target.value })} className="h-8 text-xs w-24" />
                                    </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="pt-4 space-y-2">
                                    <div className="flex gap-2">
                                        ...
                                        <Input type="number" placeholder="Amount" value={newDeduction.amount} onChange={(e) => setNewDeduction({ ...newDeduction, amount: e.target.value })} className="h-8 text-xs w-24" />
                                    </div>
