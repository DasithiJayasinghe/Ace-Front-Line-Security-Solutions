    ...
    return (
        <div className="space-y-5 pb-8">
            ...
            <nav className="flex items-center gap-1.5 text-xs text-gray-500">
                <Link to="/accountant/dashboard" className="hover:text-primary">Dashboard</Link>
                <ChevronRight className="h-3 w-3" />
                <Link to="/accountant/payments" className="hover:text-primary">Payments</Link>
                <ChevronRight className="h-3 w-3" />
                <span className="text-gray-900 font-semibold">Verify #{payment.paymentId}</span>
            </nav>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-0.5">
                            Reviewing payment from: <strong>{payment.companyName}</strong>
                        </p>
                    </div>
                </div>
                {isAlreadyDecided && (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <div className="lg:col-span-2 space-y-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div className="bg-white border border-gray-100 rounded-2xl p-5 space-y-4">
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-xs font-bold uppercase tracking-widest text-gray-400">Invoice Details</p>
                            </div>
                            {[
                        ...
                        <div className="bg-white border border-gray-100 rounded-2xl p-5 space-y-3">
                            ...
                            <div className="bg-primary/5 border border-primary/20 rounded-xl p-3">
                                ...
                                <p className="text-2xl font-black text-gray-900 mt-0.5">{formatLKR(payment.amountPaid ?? 0)}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden">
                        ...
                        <div className="p-4 bg-gray-50/50 min-h-[300px] flex items-center justify-center">
                            {!payment.paymentProofPath ? (
                            ...
                            {payment.verifiedAt && (
                                <div className="flex items-start gap-3">
                                    <div className={`w-2 h-2 rounded-full mt-1.5 shrink-0 ${
                                        payment.verificationStatus === "VERIFIED" ? "bg-emerald-500" : "bg-red-500"
                                    }`} />
                                    <div>
                ...
                <div className="space-y-5">
                    ...
                    <div className="bg-white border border-gray-100 rounded-2xl p-5">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <p className="text-sm font-bold text-gray-900">Verification Checklist</p>
                        </div>
                        <div className="space-y-3">
                            {[
                                ...
                                <label key={key} className={`flex items-start gap-3 p-2.5 rounded-lg cursor-pointer transition-all ${
                                    isAlreadyDecided ? "opacity-60 cursor-not-allowed" : "hover:bg-gray-50"
                                }`}>
                                    <input
                                        type="checkbox"
                                        checked={checks[key]}
                    ...
                    {!isAlreadyDecided ? (
                        <div className="bg-white border border-gray-100 rounded-2xl p-5 space-y-4">
                            <p className="text-sm font-bold text-gray-900">Decision Panel</p>
                                ...
                                <button
                                    ...
                                    className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 font-bold text-sm transition-all ${
                                        decision === "VERIFIED"
                                            ...
                                            : "border-gray-200 hover:border-emerald-200 text-gray-600 hover:bg-emerald-50/50 disabled:opacity-40 disabled:cursor-not-allowed"
                                    }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 font-bold text-sm transition-all ${
                                        decision === "REJECTED"
                                            ...
                                            : "border-gray-200 hover:border-red-200 text-gray-600 hover:bg-red-50/50"
                                    }`}
                                >
                            ...
                            {decision === "REJECTED" && (
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full text-sm border border-gray-200 rounded-xl px-3 py-2 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary/20"
                                    >
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={2}
                                    className="w-full text-sm border border-gray-200 rounded-xl px-3 py-2 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary/20 resize-none"
                                />
                            </div>

                            {submitResult && (
                                <div className={`rounded-xl p-3 flex gap-2 items-start text-sm ${
                                    submitResult.ok ? "bg-emerald-50 border border-emerald-200 text-emerald-700" : "bg-red-50 border border-red-200 text-red-700"
                                }`}>
                                    {submitResult.ok
                            ...
                            <button
                                ...
                                className="w-full bg-yellow-400 hover:bg-yellow-500 text-black font-black py-3 rounded-xl text-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {submitting ? (
                        ...
                        <div className="bg-white border border-gray-100 rounded-2xl p-5">
                            <p className="text-sm font-bold text-gray-900 mb-3">Decision Summary</p>
                            <div className={`rounded-xl p-4 ${
                                ...
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className={`font-bold text-sm ${
                                        payment.verificationStatus === "VERIFIED" ? "text-emerald-800" : "text-red-800"
                                    }`}>
                                        {payment.verificationStatus}
                                    </span>
                                </div>
                                {payment.remarks && (
                                    <p className="text-xs text-gray-600 mt-1">Notes: {payment.remarks}</p>
                                )}
                            </div>
                            <button onClick={() => navigate("/accountant/payments")}
                                className="mt-4 w-full border border-gray-200 text-gray-600 hover:bg-gray-50 py-2.5 rounded-xl text-sm font-semibold transition-all">
                                ← Back to Payments
                            </button>
                        </div>
                    )}
