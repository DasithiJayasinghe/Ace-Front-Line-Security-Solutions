...
export default function ExecutiveOfficerDashboard() {
  ...
  const sidebarItems = [
    ...
    { icon: Calendar, label: "Leave Management", id: "leave", link: "#" },
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          {activeItem === "loan-approvals" && (
            <div>
              <h2 className="text-3xl font-bold text-foreground mb-4">Loan Approvals</h2>
          ...
          {activeItem === "leave" && (
            <div className="space-y-6">
              <div className="mb-8">
                ...
                <p className="text-muted-foreground">Handle employee leave requests</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  { icon: Check, label: "Approved", value: "47" },
                  { icon: AlertCircle, label: "Pending", value: "5" },
