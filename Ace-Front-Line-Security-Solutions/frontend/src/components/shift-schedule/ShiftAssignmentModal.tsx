...
export const ShiftAssignmentModal = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-sm bg-black/50">
            <div className="bg-[#0D0D0D] border border-[#D4AF37] text-white p-6 rounded-lg shadow-xl w-full max-w-md">
                ...
                {!isReadOnly && (
                    <div className="flex gap-2">
                        <input
                            ...
                            className="bg-[#1A1A1A] text-white border border-gray-700 rounded px-3 py-2 flex-grow focus:outline-none focus:border-[#D4AF37]"
                        />
                        <button
                            onClick={handleAdd}
                            className="bg-[#D4AF37] text-black px-4 py-2 rounded hover:bg-yellow-600 font-semibold"
                        >
                            + Add
                        </button>
                    </div>
