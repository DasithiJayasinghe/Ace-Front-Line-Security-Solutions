      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-full flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-3">
          ...
          <div className="hidden sm:flex flex-col leading-none">
            <span className="text-base font-extrabold tracking-tight uppercase text-foreground">
              Ace Front Line
            </span>
            <span className="text-[9px] tracking-[0.15em] font-medium text-muted-foreground uppercase">
              Security Solutions
            </span>
          </div>
        </Link>
                ...
                <div className="max-h-72 overflow-y-auto">
                  {notifications.length === 0 ? (
                    ...
                    notifications.slice(0, 20).map((n) => (
                      <div
                        key={n.id}
                        className={`px-4 py-3 border-b border-border/50 last:border-0 flex items-start gap-3 cursor-pointer hover:bg-muted transition-colors ${
                          !n.read ? "bg-primary/5" : ""
                        }`}
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden sm:block text-left">
                ...
                <p className="text-[11px] text-primary/80 uppercase tracking-wider font-medium">{userRole}</p>
              </div>
            </button>
                ...
                <div className="absolute right-0 top-full mt-2 w-56 bg-popover border border-border rounded-xl shadow-2xl z-50 overflow-hidden">
                  ...
                  {profilePath && (
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-4 py-3 text-sm text-foreground/80 hover:bg-primary/10 transition-colors"
                    >
