      ...
      <div className="relative rounded-2xl overflow-hidden bg-[#1A1A1B] p-5 text-white shadow-xl">
        ...
        <div className="relative flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/50">Interview assignments & notifications</p>
            </div>
          </div>
          {unreadCount > 0 && (
            <div className="flex items-center gap-3">
        ...
        <div className="relative grid grid-cols-2 md:grid-cols-3 gap-3">
          <div className="bg-white/[0.06] backdrop-blur-sm rounded-xl p-3 text-center border border-white/[0.06] hover:bg-white/[0.1] transition-colors">
            <Bell className="h-4 w-4 mx-auto mb-1.5 text-[#FFD700]" />
            <p className="text-xl font-bold">{announcements.length}</p>
            <p className="text-[10px] text-white/40 uppercase tracking-widest mt-0.5">Total</p>
          </div>
          <div className="bg-white/[0.06] backdrop-blur-sm rounded-xl p-3 text-center border border-white/[0.06] hover:bg-white/[0.1] transition-colors">
            <Eye className="h-4 w-4 mx-auto mb-1.5 text-red-400" />
            <p className="text-xl font-bold">{unreadCount}</p>
            <p className="text-[10px] text-white/40 uppercase tracking-widest mt-0.5">Unread</p>
          </div>
          <div className="bg-white/[0.06] backdrop-blur-sm rounded-xl p-3 text-center border border-white/[0.06] hover:bg-white/[0.1] transition-colors">
            ...
            <p className="text-[10px] text-white/40 uppercase tracking-widest mt-0.5">Read</p>
          </div>
        </div>
      </div>
