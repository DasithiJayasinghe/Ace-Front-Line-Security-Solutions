...
import { ArrowLeft, Shield, ChevronDown, Upload, X, Briefcase, Award, Users, CheckCircle, MapPin, Star, Clock, Send, FileText, Phone, Mail, AlertCircle, User, Home, GraduationCap, Info } from "lucide-react";
...
const Careers = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section ref={cvSectionRef} className="bg-[#1A1A1B] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-[#FFD700] text-sm font-black uppercase tracking-[0.3em] mb-3">Don't See Your Role?</h2>
              <h3 className="text-3xl md:text-4xl font-black text-white leading-tight mb-6">
                Send Us Your <span className="text-[#FFD700]">CV</span>
              </h3>
            ...
            >
              {showCvForm ? (
                ...
                <div className="bg-card/50 backdrop-blur-sm border border-dashed border-[#FFD700]/40 rounded-2xl p-12 flex flex-col items-center justify-center text-center">
                  <div className="h-20 w-20 rounded-full bg-[#FFD700]/20 flex items-center justify-center mb-6">
                    <Send className="h-10 w-10 text-[#FFD700]" />
                  </div>
                  <h4 className="text-xl font-bold text-foreground mb-2">Ready to Apply?</h4>
                  <p className="text-[#1A1A1B] font-medium mb-6 max-w-sm">
      ...
      {/* Footer */}
      <section className="bg-[#1A1A1B] py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-[#FFD700]/50 text-sm">
